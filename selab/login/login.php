<?php
	...
	function loadSetting($id) {
		$db = new PDO("mysql:dbname=custom;host=localhost;port=3306","root","1111"); // passwoar, ip 
...
<?php
	...
	try {
		$db = new PDO("mysql:dbname=custom;host=localhost;port=3306","root","1111"); //프로젝트에는 실제 mysql의 id, password 입력
		$db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
		$id = $_POST['id'];
		$pw = $_POST['password'];
